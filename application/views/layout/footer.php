                ...
                <div class="item active">
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-3 slidering">
                            <div class="thumbnail"><img src="<?= base_url('assets/img/sl1.jpg') ?>" alt="Image" style="max-width:100%;"></div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-3 slidering">
                            <div class="thumbnail"><img src="<?= base_url('assets/img/sl3.jpg') ?>" alt="Image" style="max-width:100%;"></div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-3 slidering">
                            <div class="thumbnail"><img src="<?= base_url('assets/img/sl5.jpg') ?>" alt="Image" style="max-width:100%;"></div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-3 slidering">
                            <div class="thumbnail"><img src="<?= base_url('assets/img/sl7.jpg') ?>" alt="Image" style="max-width:100%;"></div>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="row">
                        <div class="col-md-3 col-sm-3 col-xs-3 slidering">
                            <div class="thumbnail"><img src="<?= base_url('assets/img/sl2.jpg') ?>" alt="Image" style="max-width:100%;"></div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-3 slidering">
                            <div class="thumbnail"><img src="<?= base_url('assets/img/sl4.jpg') ?>" alt="Image" style="max-width:100%;"></div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-3 slidering">
                            <div class="thumbnail"><img src="<?= base_url('assets/img/sl6.jpg') ?>" alt="Image" style="max-width:100%;"></div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-3 slidering">
                            <div class="thumbnail"><img src="<?= base_url('assets/img/sl8.jpg') ?>" alt="Image" style="max-width:100%;"></div>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="footer_agileinfo_w3">
    <div class="footer_inner_info_w3ls_agileits">
        <div class="col-md-3 footer-left">
            ...
            <h2><a href="<?= base_url() ?>"><img src="<?= base_url("assets/img/logo-bakulsepatu.png") ?>" style="margin-top:-25px;" width="200px"></a></h2>
